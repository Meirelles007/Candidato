...
public String toString() {
	return "Candidato [id=" + id + ", nome=" + nome + ", ensinoMedioPublico=" + ensinoMedioPublico
			...
			+ anosRegistroEntidadeClasse + ", pontosProva=" + pontosProva + ", getId()=" + getId() + ", getNome()="
			+ getNome() + ", isEnsinoMedioPublico()=" + isEnsinoMedioPublico() + ", isEnsinoSuperiorCompleto()="
			+ isEnsinoSuperiorCompleto() + ", getAnosRegistroEntidadeClasse()=" + getAnosRegistroEntidadeClasse()
			+ ", getPontosProva()=" + getPontosProva() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
